...
//                      1 2 3 4 5 6
    ...
    public ArrayList<Articulo> findAllByTitle(String clave) throws Exception {
        ...
        String sql = "select * from "+this.tableName+"articulos where UPPER(titulo) like '%"+clave.toUpperCase()+"%'";
    ...
    private ArrayList<Articulo> findBySQL(String sql) throws SQLException {
        ...
        while(res.next()) {
            ...
            //LocalDateTime ldt = LocalDateTime.from(fechaCreacion.toLocalDate());
